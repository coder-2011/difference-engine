...
const CALL_DIFF_SOURCE_PATH = /\.(?:bash|c|cc|cjs|cpp|cs|cts|cu|cuh|cxx|ex|exs|go|h|hh|hs|hpp|java|js|jsx|kt|kts|lua|mjs|ml|mts|php|py|rb|rs|scala|sh|sol|swift|ts|tsx|zig)$/i;
